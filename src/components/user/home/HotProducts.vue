              ...
              >
                ...
                <div class="card-body pb-lg-0">
                  ...
                  <div class="d-flex align-items-center">
                    <RouterLink
                      to="#"
                      @click="goSearch(category.products[0].tags)"
                      class="product-tag badge rounded-pill fs-6 fw-normal lh-base"
                    >
                      {{ category.products[0].tags }}
                    </RouterLink>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="w-40 d-flex flex-column">
                      <div class="card-body">
                        ...
                        <RouterLink
                          to="#"
                          @click="goSearch(category.products[1].tags)"
                          class="product-tag mb-2 badge rounded-pill fs-6 fw-normal lh-base"
                        >
                          {{ category.products[1].tags }}
                        </RouterLink>
                        <p class="text-secondary ms-auto">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="w-40 d-flex flex-column">
                      <div class="card-body">
                        ...
                        <RouterLink
                          to="#"
                          @click="goSearch(category.products[2].tags)"
                          class="product-tag mb-2 badge rounded-pill fs-6 fw-normal lh-base"
                        >
                          {{ category.products[2].tags }}
                        </RouterLink>
                        <p class="text-secondary ms-auto">
